  ...
  <div className=" ">
    ...
    <div className="md:flex mt-2">
      <div className="md:flex-shrink-0 md:w-1/2">
        <div className="md:w-full shadow-inner transition duration-500 ease-in-out bg-red-200 hover:bg-red-300 transform hover:-translate-y-1 hover:scale-110 ...">
          <Section
            image={face}
      ...
      <div className="grid-cols-3 gap-4 mt-4 md:mt-0 mb-2 md:ml-2 ">
        ...
        <div className="grid grid-cols-3 mr-2 mt-4">
          ...
          <div class="mr-4 col-span-1 col-span-2 transition duration-500 ease-in-out bg-yellow-400 hover:bg-yellow-500 transform hover:-translate-y-1 hover:scale-110 ...">
            <Section
              image={artGallery}
        ...
        <div className="grid grid-cols-3 gab-2 mt-2 ml-2 h-24 mr-2">
          ...
          <div className="col-span-1 ... text-gray-700 text-center ml-2 mr-4 bg-orange-400 p-2 shadow-inner">
