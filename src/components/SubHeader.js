...
const SubHeader = ({job, location, subTitle, infoText}) => {
    return (
        ...
        <p className="flex-auto text-center font-mono font-medium text-blue-600">{subTitle}</p>
        <p className="flex-auto text-center font-mono font-medium text-blue-500">{location}</p>
